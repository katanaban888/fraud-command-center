...
class TransactionFeature(Base):
    ...
    is_high_risk_country: Mapped[bool] = mapped_column(Boolean, nullable=False)
    is_high_risk_channel: Mapped[bool] = mapped_column(Boolean, nullable=False)
    ...
    customer_median_transaction_amount: Mapped[float] = mapped_column(Float, nullable=False)
    customer_std_transaction_amount: Mapped[float] = mapped_column(Float, nullable=False)
    ...
    customer_transaction_frequency: Mapped[float] = mapped_column(Float, nullable=False)
    customer_days_since_registration: Mapped[int] = mapped_column(Integer, nullable=False)
    deviation_from_usual_city: Mapped[bool] = mapped_column(Boolean, nullable=False)
    deviation_from_usual_country: Mapped[bool] = mapped_column(Boolean, nullable=False)
    ...
    number_of_accounts_per_device: Mapped[int] = mapped_column(Integer, nullable=False)
    number_of_senders_to_beneficiary: Mapped[int] = mapped_column(Integer, nullable=False)
    number_of_beneficiaries_from_sender: Mapped[int] = mapped_column(Integer, nullable=False)
...
class RuleDefinition(Base):
    ...
    threshold_v1: Mapped[float] = mapped_column(Float, nullable=False)
    threshold_v2: Mapped[float] = mapped_column(Float, nullable=False)
